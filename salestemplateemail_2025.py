# -*- coding: utf-8 -*-
"""SalesTemplateEmail_2025.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1TU8BO5PJNmXs4FREN4RcEDgQ8gaICTZR
"""
...
EMAIL_SUBJECT = "✨ Need a supplier for beaded handbags, Check out La Chic Designs!"
...
CATALOG_URL = "https://drive.google.com/file/d/149Rzmr8bjzndsyQM14Sjqjl5U8seVQZE/view?usp=share_link"
          ...
          <img src="cid:handbag2"
              ...
              <tr>
                <td style="padding:24px 28px; color:#333;">
                  ...
                  <p style="margin:0 0 18px; font-size:15px; line-height:1.6;">
                    I’m Manik from La Chic Designs, a handmade accessories brand known for our intricately
                    beaded handbags that blend fashion, functionality, and artistry.
                  </p>

                  <p style="margin:0 0 18px; font-size:15px; line-height:1.6;">
                    We’ve seen strong sell-through in regional retailers and boutiques, and I believe our beaded
                    pouches could add a unique touch to your accessory assortment. Our products perform especially
                    well in gift-driven displays and impulse-buy sections. Check out our 2025 handbag catalog
...
I’m Manik from La Chic Designs, a handmade accessories brand known for our intricately beaded handbags.

We’ve seen strong sell-through in regional retailers and boutiques, and I believe our beaded pouches could add a unique touch to your accessory assortment.
